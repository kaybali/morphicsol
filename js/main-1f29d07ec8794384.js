        ...
        7796: function (e, t, r) {
            ...
            class Y extends y.default.Component {
                ...
                componentDidMount() {
                    this.scrollToHash(),
                        n.isSsr &&
                            (o.isFallback || (o.nextExport && ((0, O.isDynamicRoute)(n.pathname) || location.search || X)) || (o.props && o.props.__N_SSG && (location.search || X))) &&
                            n.replace(n.pathname + "?" + String((0, j.assign)((0, j.urlQueryToSearchParams)(n.query), new URLSearchParams(location.search))), a, { _h: 1, shallow: !o.isFallback && !X }).catch((e) => {
            ...
            function y(e) {
                ...
                if (
                    ...
                    if (
                        ...
                        return r
                            ? (i.default.preload(r, h.integrity ? { as: "script", integrity: h.integrity, nonce: P } : { as: "script", nonce: P }),
                              (0, a.jsx)("script", { nonce: P, dangerouslySetInnerHTML: { __html: "(self.__next_s=self.__next_s||[]).push(" + JSON.stringify([r, { ...h, id: t }]) + ")" } }))
                            : (h.dangerouslySetInnerHTML && ((h.children = h.dangerouslySetInnerHTML.__html), delete h.dangerouslySetInnerHTML),
                              (0, a.jsx)("script", { nonce: P, dangerouslySetInnerHTML: { __html: "(self.__next_s=self.__next_s||[]).push(" + JSON.stringify([0, { ...h, id: t }]) + ")" } }));
                    "afterInteractive" === s && r && i.default.preload(r, h.integrity ? { as: "script", integrity: h.integrity, nonce: P } : { as: "script", nonce: P });
                }
                return null;
            }
                    ...
                    r = await (function (e, t, r) {
                        ...
                        if ((!l || u || l.includes("__next_data_catchall") || l.includes("/_error") || l.includes("/404") || (u = l), u)) {
                            ...
                            return Promise.resolve({
                                ...
                                destination: "" + (0, R.formatNextPathnameInfo)({ ...(0, w.getNextPathnameInfo)(t.pathname, { nextConfig: n, parseData: !0 }), defaultLocale: r.router.defaultLocale, buildId: "" }) + t.query + t.hash,
                            });
                        }
            ...
            function W(e) {
                let { dataHref: t, inflightCache: r, isPrefetch: n, hasMiddleware: o, isServerRender: a, parseJSON: u, persistCache: l, isBackground: s, unstable_skipClientCache: c } = e,
                    ...
                    d = (e) => {
                        ...
                        })(t, a ? 3 : 1, { headers: Object.assign({}, n ? { purpose: "prefetch" } : {}, n && o ? { "x-middleware-prefetch": "1" } : {}), method: null != (s = null == e ? void 0 : e.method) ? s : "GET" })
                            .then((r) =>
                                r.ok && (null == e ? void 0 : e.method) === "HEAD"
                                    ...
                                    : r.text().then((e) => {
                                          if (!r.ok) {
                                              ...
                                              if (404 === r.status) {
                                                  var n;
                                                  if (null == (n = H(e)) ? void 0 : n.notFound) return { dataHref: t, json: { notFound: B }, response: r, text: e, cacheKey: f };
                                              }
                ...
                return c && l ? d({}).then((e) => ((r[f] = Promise.resolve(e)), e)) : void 0 !== r[f] ? r[f] : (r[f] = d(s ? { method: "HEAD" } : {}));
            }
            function q() {
            ...
            class V {
                ...
                async change(e, t, r, n, o) {
                    ...
                    this._inFlightRoute && this.clc && (X || V.events.emit("routeChangeError", L(), this._inFlightRoute, J), this.clc(), (this.clc = null)),
                        (r = (0, E.addBasePath)((0, b.addLocale)((0, S.hasBasePath)(r) ? (0, v.removeBasePath)(r) : r, n.locale, this.defaultLocale)));
                    let Q = (0, P.removeLocale)((0, S.hasBasePath)(r) ? (0, v.removeBasePath)(r) : r, q.locale);
                    this._inFlightRoute = r;
                    let Z = Y !== q.locale;
                    if (!H && this.onlyAHashChange(Q) && !Z) {
                        (q.asPath = Q), V.events.emit("hashChangeStart", r, J), this.changeState(e, t, r, { ...n, scroll: !1 }), $ && this.scrollToHash(Q);
                        try {
                    ...
                    try {
                        ...
                        if ((null == w ? void 0 : null == (E = w.effect) ? void 0 : E.type) === "rewrite") {
                            ...
                            if (
                                ...
                                (i = (0, v.removeBasePath)((0, c.normalizeLocalePath)(w.effect.parsedAs.pathname, this.locales).pathname)),
                                (e = this.components[y]),
                        ...
                        return (
                            ...
                            this.isPreview || !R.__N_SSG || h || W(Object.assign({}, O, { isBackground: !0, persistCache: !1, inflightCache: this.sbc })).catch(() => {}),
                ...
                constructor(e, t, n, { initialProps: o, pageLoader: i, App: u, wrapApp: l, Component: s, err: c, subscription: f, isFallback: m, locale: _, locales: y, defaultLocale: b, domainLocales: P, isPreview: v }) {
                    ...
                    if (
                        ...
                        (this.state = { route: S, pathname: e, query: t, asPath: O ? e : n, isPreview: !!v, locale: void 0, isFallback: m }),
